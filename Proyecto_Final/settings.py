...
SECRET_KEY = 'django-insecure-#2c71xe_(6s!_b(_@)7=7z-=&)4aoy7q(&mwlxa5f#g(v)sy5i'
...
TEMPLATES = [
    {
        ...
        'DIRS': [f'{BASE_DIR}/App_Artista/Templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Directorio donde se guardan los archivos subidos por el usuario
